...
set CLASSPATH=%APP_HOME%\lib\aggregating-average-standalone-0.0.1.jar

@rem Execute aggregating-average
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %AGGREGATING_AVERAGE_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
